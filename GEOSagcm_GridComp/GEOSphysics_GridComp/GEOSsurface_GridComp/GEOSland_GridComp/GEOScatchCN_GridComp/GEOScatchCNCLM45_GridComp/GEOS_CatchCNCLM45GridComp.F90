...
! --------
      ...
      if (pso_choice == 1) then
          ...
          if (tile_alloc_stat == .false.) then
              ...
              ! start with precip
              precip_fname = '/shared/pso/step_2_env_covariates/outputs/gldas_avg_precip_normalized.nc4'
              ...
              canopy_fname = '/shared/pso/step_2_env_covariates/outputs/canopy_height_normalized.nc4'
              ...
              open(unit = 8, file='/lustre/catchment/exps/GEOSldas_CN45_pso_g1_ai_et_strm_camels_test2006/positions.csv',IOSTAT = reason)
