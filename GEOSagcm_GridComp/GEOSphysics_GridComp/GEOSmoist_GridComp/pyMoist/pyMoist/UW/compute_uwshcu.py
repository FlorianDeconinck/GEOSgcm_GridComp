...
class ComputeUwshcuInv:
    ...
    def __call__(
        ...
        self._compute_uwshcu_invert_before(
            # Inputs
            k0=k0,
            pmid0_inv=state.pmid0_inv,
            u0_inv=state.u0_inv,
            v0_inv=state.v0_inv,
            zmid0_inv=state.zmid0_inv,
            exnmid0_inv=state.exnmid0_inv,
            dp0_inv=state.dp0_inv,
            qv0_inv=state.qv0_inv,
            ql0_inv=state.ql0_inv,
            qi0_inv=state.qi0_inv,
            t0_inv=state.t0_inv,
            tke_inv=state.tke_inv,
            pifc0_inv=state.pifc0_inv,
            zifc0_inv=state.zifc0_inv,
            exnifc0_inv=state.exnifc0_inv,
            kpbl_inv=state.kpbl_inv,
            cnvtr=state.cnvtr,
            frland=state.frland,
            CNV_Tracers=state.CNV_Tracers,
        ...
        self._compute_thermodynamic_variables(
            ...
            tpert_out=state.tpert_out,
            qpert_out=state.qpert_out,
        )
        ...
        self._compute_uwshcu_invert_after(
            ...
            cush_inoutvar=self.temporaries.cush_inoutvar,
            # Outputs
            umf_inv=state.umf_inv,
            dcm_inv=state.dcm_inv,
            qtflx_inv=state.qtflx_inv,
            slflx_inv=state.slflx_inv,
            uflx_inv=state.uflx_inv,
            vflx_inv=state.vflx_inv,
            qvten_inv=state.qvten_inv,
            qlten_inv=state.qlten_inv,
            qiten_inv=state.qiten_inv,
            tten_inv=state.tten_inv,
            uten_inv=state.uten_inv,
            vten_inv=state.vten_inv,
            qrten_inv=state.qrten_inv,
            qsten_inv=state.qsten_inv,
            cufrc_inv=state.cufrc_inv,
            fer_inv=state.fer_inv,
            fdr_inv=state.fdr_inv,
            ndrop_inv=state.ndrop_inv,
            nice_inv=state.nice_inv,
            qldet_inv=state.qldet_inv,
            qlsub_inv=state.qlsub_inv,
            qidet_inv=state.qidet_inv,
            qisub_inv=state.qisub_inv,
            dotransport=dotransport,
            cush=state.cush,
        )
