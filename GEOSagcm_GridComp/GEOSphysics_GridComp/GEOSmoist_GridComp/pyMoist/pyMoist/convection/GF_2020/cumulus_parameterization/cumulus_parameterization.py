...
class GF2020CumulusParameterization(NDSLRuntime):
    ...
    #             C0=self.plume_constants[plume].C0,
    #             AVERAGE_LAYER_DEPTH=self.plume_constants[plume].AVERAGE_LAYER_DEPTH,
    #             plume=self.plume_constants[plume].PLUME_INDEX,
    #         )
    ...
    #             ocean_fraction=state.input.ocean_fraction,
    #             random_number=self.locals.random_number,
    #             DOWNDRAFT_MAX_HEIGHT_LAND=self.plume_constants[
    #                 plume
    #             ].DOWNDRAFT_MAX_HEIGHT_LAND,
    #             DOWNDRAFT_MAX_HEIGHT_OCEAN=self.plume_constants[
    #                 plume
    ...
    #             LAMBDA_DOWN=self.plume_constants[plume].LAMBDA_DOWN,
    #             plume=self.plume_constants[plume].PLUME_INDEX,
    #         )
    ...
    #                 :, :, :, self.plume_constants[plume].PLUME_INDEX
    #             ],
    #             topography_height_no_negative=state.input_output.topography_height_no_negative,
    #             geopotential_height=self.locals.geopotential_height_modified,
    ...
    #             precipitation_ensemble=self.locals.precipitation_ensemble,
    #             xff_mid=self.locals.xff_mid,
    #             CLOSURE_CHOICE=self.plume_constants[plume].CLOSURE_CHOICE,
    #             CLOUD_BASE_MASS_FLUX_FACTOR=self.plume_constants[
    #                 plume
    #             ].CLOUD_BASE_MASS_FLUX_FACTOR,
    #             plume=self.plume_constants[plume].PLUME_INDEX,
    #         )
